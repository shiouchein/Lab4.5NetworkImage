...
public class CameraActivity extends AppCompatActivity {
    ...
    public void uploadImage(View view) {
        try {
            //new CameraActivity.PostDataTOServer().execute();
            makeServiceCall(this, getString(R.string.url_insert_image), image);
        } catch (Exception e) {
    ...
    public void makeServiceCall(Context context, String url, final String image) {
